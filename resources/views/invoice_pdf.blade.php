...
<body class="login-page" style="background: white">
    ...
    <div>
        <div class="row">
            ...
            <div class="col-xs-4">
                <img src="{{ asset('images/logo_size.jpg') }}" alt="logo">
            </div>
        </div>
        ...
        <table class="table">
            ...
            <div class="row">
                <div class="col-xs-8 invbody-terms">
                    ...
                    <br>
                    <h4>Payment Terms</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad eius quia, aut doloremque, voluptatibus quam ipsa sit sed enim nam dicta!</p>
                </div>
            </div>
        </div>
