...
<div class="container">
<h1 align="center">Laravel Datatables</h1>
<br/>
<div class="row">
...
<form name="userForm"  method="POST">{{-- action="{{ route('users.store') }}" --}}
...
<button type="button" id="btn-save" name="btnsave" class="btn btn-primary" disabled>Save</button>
<a  id="cancel_edit" class="btn btn-danger">Cancel</a>
</div>
</div>
</form>
</div>
...
<tr><td></td><td style="text-align: right "><a id="show_ok" class="btn btn-danger">OK</a> </td></tr>
</table>
</div>
</div>
</div>
...
$.ajax({
type: "DELETE",
url: "http://localhost/datatables/public/users/"+user_id,
data: {
"id": user_id,
"_token": token,
},
...
$('body').on('click', "#show_ok", function(){
